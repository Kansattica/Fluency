...
namespace Fluency.Execution.Functions.BuiltIn.Factory
{
    public class BuiltInFactory : IFunctionResolver
    {
        ...
        public static IReadOnlyDictionary<string, FunctionMaker> BuiltInFunctions = new Dictionary<string, FunctionMaker>()
        {
            ...
            {"MultDouble", (args) => new WrapBinary<double, double, double>((a, b) => a * b, FluencyType.Double, FluencyType.Double,"MultDouble", args )},
            ...
            {"ParseDouble", (_) => new WrapUnary<string, double>(double.Parse, FluencyType.Double, "ParseDouble")},
            ...
            {"DivDouble", (args) => new WrapBinary<double, double, double>((a, b) => a/b , FluencyType.Double, FluencyType.Double, "DivDouble", args )},
        };
