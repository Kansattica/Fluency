...
namespace Fluency.Execution.Functions.BuiltIn.Factory
{
    public class BuiltInFactory : IFunctionResolver
    {
        ...
        public static IReadOnlyDictionary<string, FunctionMaker> BuiltInFunctions = new Dictionary<string, FunctionMaker>()
        {
            ...
            {"Add", (topArgs, _) => new WrapBinary<int, int, int>((a, b) => a + b, FluencyType.Int, FluencyType.Int,"Add", topArgs )},
            {"Mult", (topArgs, _) => new WrapBinary<int, int, int>((a, b) => a * b, FluencyType.Int, FluencyType.Int,"Mult", topArgs )},
            {"MultDouble", (topArgs, _) => new WrapBinary<double, double, double>((a, b) => a * b, FluencyType.Double, FluencyType.Double,"MultDouble", topArgs )},
            ...
            {"Equals", (topArgs, _) => new WrapBinary<object, object, bool>((a, b) => a.Equals(b) , FluencyType.Any, FluencyType.Bool, "Equals", topArgs)},
            {"LessThan", (topArgs, _) => new WrapBinary<int, int, bool>((a, b) => a < b, FluencyType.Int, FluencyType.Bool, "LessThan", topArgs)},
            {"GreaterThan", (topArgs, _) => new WrapBinary<int, int, bool>((a, b) => a > b, FluencyType.Int, FluencyType.Bool, "GreaterThan", topArgs)},
